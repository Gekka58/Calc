    ...
    public String calc(String inputString) throws Exception {
        ...
        if (str.length == 2){
            ...
            if (ifOperandArabian(values1) && ifOperandArabian(values2)) {
                ...
                throw new Exception("Выражение должно быть: Либо арабским, либо римским, числа от 1 до 10 включительно.");
            }
        }
        else {
            throw new Exception("Вы ввели не подхожящее выражение.");
        }
        return result;
    }
        ...
        switch(operacion){
            ...
            case '/':
                if (val2!=0) {
                    ...
                    throw new Exception("Деление на 0 запрещенно!");
                }
        }
    }
